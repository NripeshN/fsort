...
from fsort.formatters import BaseFormatter


def class_build_dependency_graph(
    nodes_with_comments: List[Tuple[str, ast.AST]]
) -> nx.DiGraph:
    """
...
def assignment_build_dependency_graph(
    nodes_with_comments: List[Tuple[str, ast.AST]]
) -> nx.DiGraph:
    """
...
def related_helper_function(
    assignment_name: str, nodes_with_comments: List[Tuple[str, ast.AST]]
) -> str:
    """
